...
export default function SkillCard({ image, name }: SkillCardProps) {
  return (
    <div className="bg-slate-900 w-40 h-w-40 px-6 py-4 text-center text-white p-5 rounded-2xl hover:bg-slate-800 transition-all hover:scale-105 hover:shadow-2xl">
